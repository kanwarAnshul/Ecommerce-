...
const stats = [
  ...
  { name: 'Countries Shipped To', value: '30+' },
];
...
export default function AboutPage() {
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      <img
        alt=""
        src="https://images.unsplash.com/photo-1556910096-6f5e69c1f999?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2800&q=80"
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-7xl lg:mx-0">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            From timeless classics to the latest trends, explore a curated selection of apparel that elevates your style. Quality, sustainability, and customer satisfaction are at the heart of everything we do.
          </p>
        </div>
